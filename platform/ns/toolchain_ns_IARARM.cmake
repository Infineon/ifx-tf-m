...
set(IAR_DIAG_SUPPRESS "Pe546,Pe940,Pa082,Pa084")
# Pa217 was introduced in IAR 9.70.4 (TPB-3967); older compilers reject the unknown tag.
if(IAR_VERSION VERSION_GREATER_EQUAL "9.70.4")
    string(APPEND IAR_DIAG_SUPPRESS ",Pa217")
endif()
...
add_compile_options(
    ...
    $<$<COMPILE_LANGUAGE:C,CXX>:--diag_suppress=${IAR_DIAG_SUPPRESS}>

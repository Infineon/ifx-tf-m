...
#ifndef PLATFORM_EXCEPTION_INFO_ENTER_HOOK
/* This macro can be redefined in tfm_platform_arch_hooks.h to handle platform
...
#define EXCEPTION_INFO()                   \
    PLATFORM_EXCEPTION_INFO_ENTER_HOOK();  \
    __ASM volatile(                        \
        "MRS    R0, MSP\n"                 \
        "MRS    R1, PSP\n"                 \
        "MOV    R2, R11\n"                 \

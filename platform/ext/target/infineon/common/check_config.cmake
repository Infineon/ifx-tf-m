...
tfm_invalid_config(IFX_MTB_SCMI AND NOT IFX_MTB_SRF)
...
# SCMI tests require MTB SCMI to be enabled
tfm_invalid_config(TEST_NS_IFX_MTB_SCMI AND NOT IFX_MTB_SCMI)

# EPC profile validation must use the matching TF-M profile
tfm_invalid_config(TEST_NS_IFX_EPC_VALIDATION
                   AND IFX_TEST_EXTRA_INFO STREQUAL "VERIFY_PROFILE_MEDIUM"
                   AND NOT (TFM_PROFILE STREQUAL "profile_medium"))
tfm_invalid_config(TEST_NS_IFX_EPC_VALIDATION
                   AND IFX_TEST_EXTRA_INFO STREQUAL "VERIFY_PROFILE_LARGE"
                   AND NOT (TFM_PROFILE STREQUAL "profile_large"))

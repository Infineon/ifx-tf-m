...
#define MBEDTLS_PSA_ACCEL_ALG_CCM
	...
	(!defined(IFX_CRYPTOSUITE_ENABLED) || !defined(PSA_WANT_ALG_SP800_108_COUNTER_CMAC))
...
//#define MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_PUBLIC_KEY (not supported without ECC key pair import)
#endif
...
//#define MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_BASIC (not supported without ECC key pair import)
#endif
...
//#define MBEDTLS_PSA_ACCEL_KEY_TYPE_ECC_KEY_PAIR_EXPORT (not supported without ECC key pair import)
#endif

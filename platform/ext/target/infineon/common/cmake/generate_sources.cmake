...
if(NOT IFX_GENERATE_BSP_SOURCES)
    # Tools are only needed when BSP source generation is performed. Thus, if
    # source generation is skipped, the caller must provide path to generated files.
...
function(ifx_generate_sources)
    ...
    # Generate BSP sources only if enabled. Otherwise, the caller must provide
    # path to already generated sources.
    if(IFX_GENERATE_BSP_SOURCES)
        ...
        add_custom_command(
            ...
            COMMAND ${IFX_DEVICE_CONFIGURATOR_CLI_EXECUTABLE}
                        ...
                        # regenerations)
                        --readonly
                        # Force regeneration even if previously generated
                        # files have been modified (e.g. touch by CMake).
                        --force

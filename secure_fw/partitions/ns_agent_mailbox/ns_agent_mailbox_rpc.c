...
static inline void tfm_rpc_client_process_reply(bool call_reply_op)
{
    psa_msg_t msg;
...
{
    tfm_rpc_client_process_reply(true);
}

void tfm_rpc_client_drop_reply(void)
{
    tfm_rpc_client_process_reply(false);
}

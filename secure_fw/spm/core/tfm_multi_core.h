...
/**
 * \brief Enable the multi core communication.
 *
 * This is called after tfm_inter_core_init() and may be called again
 * after tfm_inter_core_disable().
 *
 * \retval 0                    Operation succeeded.
 * \retval Other return code    Operation failed with an error code.
 */
...
/**
 * \brief Disable the multi core communication.
 *
 * This may be called to return the multi core communication to the
 * initialised, but not enabled, state.
 *
 * \retval 0                    Operation succeeded.
 * \retval Other return code    Operation failed with an error code.
 */
...
/**
 * \brief De-initialization of the multi core communication.
 *
 * This may be called to return the multi-core communication from the
 * initialised, but not enabled state to the pre-initialised state.
 *
 * \retval 0                    Operation succeeded.
 * \retval Other return code    Operation failed with an error code.
 */

...
/* If there is a separate non-secure core, boot it during SPM startup */
#ifndef CONFIG_TFM_AUTO_BOOT_NS_CORE
#define CONFIG_TFM_AUTO_BOOT_NS_CORE            1
#endif
...
/*
 * Whether to remap caller address to SPM address space during psa call operations.
 */
#ifndef CONFIG_TFM_PSA_CALL_ADDRESS_REMAP
#define CONFIG_TFM_PSA_CALL_ADDRESS_REMAP      0
#endif

/*
 * Determines whether a dedicated section for the data shared with the
 * bootloader should be allocated within the TFM data section.
 */
#ifndef CONFIG_TFM_ALLOCATE_SHARED_DATA_SECTION
#define CONFIG_TFM_ALLOCATE_SHARED_DATA_SECTION 1
#endif
